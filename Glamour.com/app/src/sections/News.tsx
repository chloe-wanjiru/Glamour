      ...
      <div className="container-custom relative">
        ...
        <div className="fade-up flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          ...
          {newsConfig.viewAllText && (
            <a
              href="https://pinterest.com/search?q=beauty+tips"
              target="_blank"
              rel="noopener noreferrer"
              className="btn-dark rounded-sm flex items-center gap-2 group w-fit"
              ...
              >
                ...
                <div>
                  ...
                  {newsConfig.readMoreText && (
                    <a
                      href={`https://pinterest.com/search?q=${encodeURIComponent(item.title)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-gold-500 text-sm group-hover:gap-3 transition-all duration-300"
                    >
                      {newsConfig.readMoreText}
